...
form.addEventListener("submit", async (e) => {
  ...
  try {
    const res = await fetch("https://script.google.com/macros/s/AKfycbytPBfFnX-HatoEXIRyeBWqxB1Mcb2VUIqT6w7KC6EvL5wAoBCcuegHF1LTn6gZ33Jo1w/exec?mode=csv&pass=admin123", {
      method: "POST",
